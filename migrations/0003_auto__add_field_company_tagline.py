...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.tagline'
        db.add_column(u'feedb_company', 'tagline',
                      self.gf('django.db.models.fields.CharField')(default='pass', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.tagline'
        db.delete_column(u'feedb_company', 'tagline')
