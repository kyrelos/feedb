...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feedb_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=45))

    def backwards(self, orm):

        # Changing field 'Company.name'
        db.alter_column(u'feedb_company', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
